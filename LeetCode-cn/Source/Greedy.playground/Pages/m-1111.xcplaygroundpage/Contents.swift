...
/*:
 ...
 - 题号：[1111](https://leetcode-cn.com/problems/maximum-nesting-depth-of-two-valid-parentheses-strings/)
 - 难度：中等
 - 描述：
    ...
    **嵌套深度** `depth` 定义：即有效括号字符串嵌套的层数，`depth(A)` 表示有效括号字符串 `A` 的嵌套深度。
    ...
    有效括号字符串类型与对应的嵌套深度计算方法如[图](https://assets.leetcode-cn.com/aliyun-lc-upload/uploads/2020/04/01/1111.png)所示
